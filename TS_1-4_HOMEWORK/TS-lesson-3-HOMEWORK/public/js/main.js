...
const treesArr = ['Liepa', 'Maumedis', 'Eglė', 'Pušis', 'Klevas', 'Kaštonas', 'Beržas'];
console.group('1. Parašykite funkciją, kuri atspausdina paskutinio masyvo elemento indeksą');
{
    const lastElementIndex = (arr) => arr.length - 1;
    console.table({
...
console.groupEnd();
const randomsNumbers1 = [1, 5, 14, 6, 7, 10, 11, 3, 7];
const randomsNumbers2 = [1.5, 2.1, 6.6, 2.5, 4.8, 1.4, 3.5, 1, 2, 3];
...
{
    const numberMultiplier = (arr) => arr.map((element) => element * 2);
...
{
    const numberSuqared = (arr) => arr.map((element) => element ** 2);
...
{
    const numberMultiplierIndex = (arr) => arr.map((element, index) => element * index);
...
console.groupEnd();
const randomsNumbers3 = [1, -5, 14, -6, -7, 10, 11, -3, 7];
const randomsNumbers4 = [1.5, -2.1, 6.6, -2.5, -4.8, 1.4, 3.5, 1, -2, -3];
...
{
    const positiveNumbers = (array) => array.filter((number) => number > 0);
...
{
    const nonPositiveNumbers = (array) => array.filter((number) => number <= 0);
...
{
    const equalNumbers = (array) => array.filter((number) => number % 2 === 0);
...
{
    const nonEquallNumbers = (array) => array.filter((number) => number % 2 !== 0);
...
{
    function positiveNumbersConverter(array) {
