...
console.group('Literal types - užduotys');
{
    ...
    {
        const germanCityOne = 'Frankfurt am Main';
        const germanCityTwo = 'Berlin';
    ...
    {
        const dogBreedOne = 'German Shepherd';
        const dogBreedTwo = 'Collie';
    ...
    {
        const carPartOne = 'Head lights';
        const carPartTwo = 'Tail lights';
